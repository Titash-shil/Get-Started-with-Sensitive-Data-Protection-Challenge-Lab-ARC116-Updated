...
echo -e "${RED_TEXT}${BOLD_TEXT}Subscribe to my Channel: QwikLab Explorers ${RESET_FORMAT} ${BLUE_TEXT}${BOLD_TEXT}https://www.youtube.com/@qwiklabexplorers${RESET_FORMAT}"
echo
